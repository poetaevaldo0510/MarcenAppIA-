...
import { User, Coins, Loader2 } from 'lucide-react';
...
import { PlanBudgeter } from './modules/PlanBudgeter';
...
export const App: React.FC = () => {
  ...
  useEffect(() => {
    setAppReady(true);
    if (isAuthorized && userEmail === 'evaldo@marcenapp.com.br' && activeModule === 'dashboard') {
  ...
  const renderModule = () => {
    switch(activeModule) {
      ...
      case 'suppliers': return <SupplierIntelligence />;
